...
router.post('/blogs', firebaseAuth('admin'), upload.single('thumbnail'), blogController.createBlog);
...
router.post('/categories', firebaseAuth('admin'), upload.single('categoryImage'),  CategoryController.createCategory);
...
router.post('/topics', firebaseAuth('admin'), TopicController.createTopic);
